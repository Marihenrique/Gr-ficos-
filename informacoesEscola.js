...
async function vizualizarInformacoesGlobais() {
    ...
    Você sabia que a escola possui aproximadamente <span style="color: ${corAleatoria};">5.000 alunos</span>? Dentre esses, cerca de <span style="color: ${corAleatoria};">${alunosConectados} alunos</span> estão ativos em redes sociais. <br>
